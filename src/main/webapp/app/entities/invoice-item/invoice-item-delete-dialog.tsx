...
export const InvoiceItemDeleteDialog = (props: IInvoiceItemDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="tatraInvoiceApp.invoiceItem.delete.question">
        <Translate contentKey="tatraInvoiceApp.invoiceItem.delete.question" interpolate={{ id: invoiceItemEntity.id }}>
          Are you sure you want to delete this InvoiceItem?
        </Translate>
      </ModalBody>
      <ModalFooter>
