package cz.drivefuture.tatrainvoice.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, cz.drivefuture.tatrainvoice.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, cz.drivefuture.tatrainvoice.repository.UserRepository.USERS_BY_EMAIL_CACHE);
