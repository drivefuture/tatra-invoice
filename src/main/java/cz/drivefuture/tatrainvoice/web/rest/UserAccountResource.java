...
/**
 * REST controller for managing {@link cz.drivefuture.tatrainvoice.domain.UserAccount}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class UserAccountResource {
    ...
    public ResponseEntity<UserAccount> createUserAccount(@Valid @RequestBody UserAccount userAccount) throws URISyntaxException {
        ...
        Long userId = userAccount.getUser().getId();
        userRepository.findById(userId).ifPresent(userAccount::user);
